...
Each packagein Big Bang includes documentation of its own High Availability configuration independantly in [Package Architecture](../package-architecture). Below are direct links for each package:  
